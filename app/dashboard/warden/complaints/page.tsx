...
export default function WardenComplaintsPage() {
  ...
  const [complaints, setComplaints] = useState<Complaint[]>([
    {
      ...
      comments: [
        { user: "Warden", text: "Maintenance team has been notified", date: "2023-04-02" },
    ...
    },
    {
      ...
      block: "B",
      type: "Electrical",
      issue: "Lights not working in room",
      description: "The lights in our room stopped working suddenly. We've checked the switch and it seems fine.",
      date: "2023-04-05",
      status: "Pending",
      priority: "High",
      assignedTo: "",
    ...
    },
    {
      ...
      description: "The study chair in my room has a broken leg. Need replacement as soon as possible.",
      date: "2023-04-10",
      status: "Resolved",
      priority: "Low",
      assignedTo: "Maintenance Staff",
      comments: [
        { user: "Warden", text: "Chair replacement approved", date: "2023-04-11" },
        { user: "Maintenance", text: "New chair installed", date: "2023-04-12" },
      ],
    },
    {
      id: "C-2023-004",
      ...
      description: "Wi-Fi connection is very weak in my room. Can't attend online classes properly.",
      date: "2023-04-15",
      status: "In Progress",
      priority: "High",
      assignedTo: "IT Support",
      comments: [
        { user: "Warden", text: "Forwarded to IT department", date: "2023-04-15" },
      ],
    },
    {
      id: "C-2023-005",
      ...
      block: "A",
      type: "Cleaning",
      issue: "Common area not cleaned properly",
      description: "The common area on our floor hasn't been cleaned for 2 days. There's garbage accumulating.",
      date: "2023-04-18",
      status: "Resolved",
      priority: "Medium",
      assignedTo: "Cleaning Staff",
      comments: [
        { user: "Warden", text: "Cleaning scheduled", date: "2023-04-18" },
        { user: "Cleaning", text: "Area cleaned", date: "2023-04-19" },
      ],
    },
    {
      id: "C-2023-006",
      ...
      block: "B",
      type: "Security",
      issue: "Unauthorized person in hostel",
      description: "Saw an unknown person wandering in the hostel premises late at night. Looked suspicious.",
      date: "2023-04-20",
      status: "Resolved",
      priority: "High",
      assignedTo: "Security Staff",
      comments: [
        { user: "Warden", text: "Security alerted", date: "2023-04-20" },
        { user: "Security", text: "Person identified as guest, escorted out", date: "2023-04-21" },
      ],
    },
    {
      id: "C-2023-007",
      ...
      block: "A",
      type: "Plumbing",
      issue: "Toilet flush not working",
      description: "The flush in our attached bathroom is not working properly. Needs immediate attention.",
      date: "2023-04-22",
      status: "Pending",
      priority: "High",
      assignedTo: "",
  ...
  const filteredComplaints = complaints.filter((complaint) => {
    ...
    const matchesBlock = blockFilter === "all" || complaint.block.toLowerCase() === blockFilter.toLowerCase()
    const matchesPriority = priorityFilter === "all" || complaint.priority.toLowerCase() === priorityFilter.toLowerCase()
    
    return matchesSearch && matchesType && matchesBlock && matchesPriority
  })
  ...
  const handleRejectComplaint = (complaintId: string) => {
    const updatedComplaints = complaints.map(c => {
      if (c.id === complaintId) {
        return {
          ...c,
          status: "Rejected" as Complaint['status'],
          assignedTo: ""
        }
      }
      return c
        ...
        <Tabs defaultValue="all" className="w-full">
                          ...
                          paginatedComplaints.map((complaint) => (
                            <tr key={complaint.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                              ...
                              <td className="p-3 text-sm">
                                ...
                                <div className="text-xs text-muted-foreground">Block {complaint.block}, Room {complaint.room.split('-')[1]}</div>
                              </td>
                              {!isMobile && (
                                <>
                                    ...
                                    complaint.status === "Resolved"
                                      ...
                                      : complaint.status === "In Progress"
                                        ...
                                        : complaint.status === "Rejected"
                                          ? "bg-gray-100 text-gray-800 hover:bg-gray-100 dark:bg-gray-900/30 dark:text-gray-300 text-xs"
                                          : "bg-amber-100 text-amber-800 hover:bg-amber-100 dark:bg-amber-900/30 dark:text-amber-300 text-xs"
                                  }
                                >
                                  {complaint.status}
                                        ...
                                        <div className="grid gap-4 py-4">
                                          ...
                                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            ...
                                            <div className="space-y-1">
                                              ...
                                              <p className="font-medium text-sm">Block {viewingComplaint.block}, Room {viewingComplaint.room.split('-')[1]}</p>
                                            </div>
                                          </div>
                                                  ...
                                                  viewingComplaint.status === "Resolved"
                                                    ...
                                                    : viewingComplaint.status === "In Progress"
                                                      ...
                                                      : viewingComplaint.status === "Rejected"
                                                        ? "bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-300 text-xs"
          ...
          <TabsContent value="in-progress">
            <ComplaintStatusTable 
              ...
              onMarkResolved={(id) => handleUpdateStatus(id, "Resolved")}
            />
          </TabsContent>
...
function ComplaintStatusTable({ complaints, status, isMobile, onViewComplaint, onAssignComplaint, onAddComment, onMarkResolved, onRejectComplaint }: {
  ...
  onMarkResolved?: (complaintId: string) => void
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                {complaints.length > 0 ? (
                    ...
                    <tr key={complaint.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                      ...
                      <td className="p-3">
                        <div className="flex items-center gap-2">
                          ...
                          {status === "In Progress" && onMarkResolved && (
                            <Button 
                              variant="outline" 
                              size="sm" 
                              className="text-xs sm:text-sm"
                          ...
                          {status === "Pending" && onRejectComplaint && (
                            <Button 
                              variant="outline" 
                              size="sm" 
                              className="text-red-600 dark:text-red-400 text-xs sm:text-sm"
                              onClick={() => onRejectComplaint(complaint.id)}
                            >
                              Reject
                            </Button>
                          )}
                  ...
                  <tr>
                    <td colSpan={status === "In Progress" ? 7 : 6} className="p-6 text-center text-muted-foreground text-sm">
